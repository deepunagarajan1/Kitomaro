<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLogin.master" AutoEventWireup="true" CodeFile="UserDetail.aspx.cs" Inherits="UserDetails" %>
        ...
        <tr>
            ...
            <td class="auto-style7" bgcolor="#FAFAD2"><center>
                <asp:Button ID="btnlgout" runat="server" OnClick="btnlgout_Click" Text="Logout" 
                    style="height: 26px; margin-left: 0px" />
                </center>
            </td>
        </tr>
        <tr>
