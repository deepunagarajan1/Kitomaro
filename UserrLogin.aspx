                ...
                <table class="auto-style8" bgcolor="#FAFAD2">
                    <tr>
                        ...
                        <td class="auto-style19" bgcolor="#FAFAD2">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxLUN" ErrorMessage="Required"></asp:RequiredFieldValidator>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style19" bgcolor="#FAFAD2">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxLP" ErrorMessage="Required"></asp:RequiredFieldValidator>
                        </td>
                        <td class="auto-style16" bgcolor="#FAFAD2"></td>
                    </tr>
                    <tr>
