            ...
            <table class="auto-style8" bgcolor="transparent">
                ...
                <tr>
                    ...
                    <td class="auto-style10">
                        <asp:TextBox ID="TextBoxPH" runat="server" Height="29px" Width="255px" 
                            BackColor="#FFFFCC" BorderColor="#FFCC99" BorderWidth="3px" CssClass="textr"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:TextBox ID="TextBoxCP" runat="server" Height="29px" Width="255px" BackColor="#FFFFCC" BorderColor="#FFCC99" BorderWidth="3px" CssClass="textr"></asp:TextBox>
                    </td>
